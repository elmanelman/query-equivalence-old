...
CALCITE_TEST_CASES = [
    Case("testAddRedundantSemiJoinRule",
    ...
    Case("testAggregateConstantKeyRule",
    ...
    Case("testAggregateConstantKeyRule2",
    ...
    Case("testAggregateConstantKeyRule3",
    ...
    Case("testAggregateGroupingSetsProjectMerge",
    ...
    Case("testAggregateProjectMerge",
         "SELECT EMP.DEPTNO AS X, SUM(EMP.SAL), EMP.EMPNO AS Y FROM EMP AS EMP GROUP BY EMP.DEPTNO, EMP.EMPNO",
         "SELECT EMP0.DEPTNO AS X, SUM(EMP0.SAL), EMP0.EMPNO AS Y FROM EMP AS EMP0 GROUP BY EMP0.EMPNO, EMP0.DEPTNO",
         True,
         ),
    Case("testAggregateProjectPullUpConstants",
    ...
    Case("testAlreadyFalseEliminatesFilter",
         "SELECT * FROM (VALUES  (1, 2)) AS t WHERE FALSE",
         "SELECT * FROM (VALUES  (1, 2)) AS t1 WHERE FALSE",
         True,
         ),
    Case("testCastInAggregateExpandDistinctAggregatesRule",
    ...
    Case("testCastInAggregateReduceFunctions",
    ...
    Case("testDistinctCountGroupingSets1",
    ...
    Case("testDistinctCountMultiple",
    ...
    Case("testDistinctCountMultipleNoGroup",
    ...
    Case("testExpandFilterExistsSimple",
    ...
    Case("testExpandFilterExistsSimpleAnd",
    ...
    Case("testExpandFilterInComposite",
    ...
    Case("testExpandProjectInComposite",
    ...
    Case("testExtractJoinFilterRule",
         "SELECT 1 FROM EMP AS EMP INNER JOIN DEPT AS DEPT ON EMP.DEPTNO = DEPT.DEPTNO",
         "SELECT 1 FROM EMP AS EMP0, DEPT AS DEPT0 WHERE EMP0.DEPTNO = DEPT0.DEPTNO",
         True,
         ),
    Case("testFullOuterJoinSimplificationToInner",
    ...
    Case("testFullOuterJoinSimplificationToLeftOuter",
    ...
    Case("testFullOuterJoinSimplificationToRightOuter",
    ...
    Case("testIntersectToDistinctAll",
    ...
    Case("testLeftOuterJoinSimplificationToInner",
    ...
    Case("testPullAggregateThroughUnion",
    ...
    Case("testPullConstantIntoFilter",
    ...
    Case("testPullConstantIntoJoin2",
    ...
    Case("testPullConstantIntoProject",
    ...
    Case("testPullConstantThroughAggregatePermutedConstGroupBy",
    ...
    Case("testPullConstantThroughUnion",
    ...
    Case("testPullConstantThroughUnion2",
    ...
    Case("testPullConstantThroughUnion3",
    ...
    Case("testPullFilterThroughAggregate",
    ...
    Case("testPullFilterThroughAggregateGroupingSets",
         "SELECT t0.ENAME, t0.SAL, t0.DEPTNO FROM (SELECT EMP.ENAME, EMP.SAL, EMP.DEPTNO FROM EMP AS EMP) AS t0 WHERE t0.SAL > 5000 GROUP BY t0.ENAME, t0.SAL, t0.DEPTNO",
    ...
    Case("testPushAggregateFunctionsThroughJoin",
    ...
    Case("testPushAggregateSumThroughJoin",
    ...
    Case("testPushAggregateThroughJoin1",
    ...
    Case("testPushAggregateThroughJoin2",
    ...
    Case("testPushAggregateThroughJoin3",
    ...
    Case("testPushAggregateThroughJoin4",
    ...
    Case("testPushAggregateThroughJoin5",
    ...
    Case("testPushAggregateThroughJoinDistinct",
    ...
    Case("testPushAvgGroupingSetsThroughUnion",
    ...
    Case("testPushCountFilterThroughUnion",
    ...
    Case("testPushCountNullableGroupingSetsThroughUnion",
    ...
    Case("testPushCountNullableThroughUnion",
    ...
    Case("testPushCountStarGroupingSetsThroughUnion",
    ...
    Case("testPushCountStarThroughUnion",
    ...
    Case("testPushFilterPastAggThree",
    ...
    Case("testPushFilterPastAggWithGroupingSets1",
    ...
    Case("testPushFilterPastAggWithGroupingSets2",
    ...
    Case("testPushFilterThroughSemiJoin",
    ...
    Case("testPushFilterWithRankExpr",
    ...
    Case("testPushJoinCondDownToProject",
    ...
    Case("testPushMaxNullableGroupingSetsThroughUnion",
    ...
    Case("testPushMaxNullableThroughUnion",
    ...
    Case("testPushMinGroupingSetsThroughUnion",
    ...
    Case("testPushProjectPastFilter",
    ...
    Case("testPushProjectPastFilter2",
    ...
    Case("testPushProjectPastFullJoin",
    ...
    Case("testPushProjectPastFullJoinStrong",
    ...
    Case("testPushProjectPastInnerJoin",
    ...
    Case("testPushProjectPastInnerJoinStrong",
    ...
    Case("testPushProjectPastLeftJoin",
    ...
    Case("testPushProjectPastLeftJoinSwap",
    ...
    Case("testPushProjectPastLeftJoinSwapStrong",
    ...
    Case("testPushProjectPastRightJoin",
    ...
    Case("testPushProjectPastRightJoinStrong",
    ...
    Case("testPushProjectPastRightJoinSwap",
    ...
    Case("testPushProjectPastRightJoinSwapStrong",
    ...
    Case("testPushSemiJoinPastJoinRuleLeft",
    ...
    Case("testPushSemiJoinPastJoinRuleRight",
    ...
    Case("testPushSumCountStarGroupingSetsThroughUnion",
    ...
    Case("testPushSumCountStarThroughUnion",
    ...
    Case("testPushSumNullableGroupingSetsThroughUnion",
    ...
    Case("testPushSumNullableNOGBYThroughUnion",
    ...
    Case("testPushSumNullableThroughUnion",
    ...
    Case("testReduceCompositeInSubQuery",
    ...
    Case("testReduceConstantsCaseEquals",
    ...
    Case("testReduceConstantsEliminatesFilter",
         "SELECT * FROM (VALUES (1, 2)) AS t WHERE 1 + 2 > 3 + NULL",
         "SELECT * FROM (VALUES (1, 2)) AS t1 WHERE FALSE",
         True,
         ),
    Case("testReduceConstantsIsNotNull",
    ...
    Case("testRemoveSemiJoinRightWithFilter",
    ...
    Case("testRemoveSemiJoinWithFilter",
    ...
    Case("testRightOuterJoinSimplificationToInner",
    ...
    Case("testSemiJoinReduceConstants",
    ...
    Case("testSortJoinTranspose4",
         "SELECT * FROM EMP AS EMP RIGHT JOIN DEPT AS DEPT ON EMP.DEPTNO = DEPT.DEPTNO ORDER BY DEPT.NAME",
         "SELECT * FROM EMP AS EMP0 RIGHT JOIN (SELECT * FROM DEPT AS DEPT0 ORDER BY DEPT0.NAME) AS t0 ON EMP0.DEPTNO = t0.DEPTNO ORDER BY t0.NAME",
         True,
         ),
    Case("testSortJoinTranspose5",
    ...
    Case("testSortProjectTranspose1",
    ...
    Case("testSortProjectTranspose2",
    ...
    Case("testSortProjectTranspose3",
    ...
    Case("testTransitiveInferenceAggregate",
    ...
    Case("testTransitiveInferenceComplexPredicate",
    ...
    Case("testTransitiveInferenceConjunctInPullUp",
    ...
    Case("testTransitiveInferenceConstantEquiPredicate",
    ...
    Case("testTransitiveInferenceFullOuterJoin",
    ...
    Case("testTransitiveInferenceJoin",
    ...
    Case("testTransitiveInferenceJoin3way",
    ...
    Case("testTransitiveInferenceJoin3wayAgg",
    ...
    Case("testTransitiveInferenceLeftOuterJoin",
    ...
    Case("testTransitiveInferenceNoPullUpExprs",
    ...
    Case("testTransitiveInferencePreventProjectPullUp",
    ...
    Case("testTransitiveInferenceRightOuterJoin",
    ...
    Case("testTransitiveInferenceUnion",
    ...
    Case("testTransitiveInferenceUnion3way",
    ...
    Case("testTransitiveInferenceUnionAlwaysTrue",
    ...
    Case("testWhereNotInCorrelated2",
...
def test_calcite(test_case, test_checker):
    assert test_case.are_equivalent == test_checker.check(test_case.query1, test_case.query2)
